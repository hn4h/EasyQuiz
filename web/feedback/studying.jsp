        ...
        <main class="container mx-auto px-4 py-8">
            ...
            <section class="mt-8">
                <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div class="bg-white p-4 rounded-lg shadow-sm cursor-pointer" onclick="showDetails('stu1')">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm cursor-pointer" onclick="showDetails('stu2')">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm cursor-pointer" onclick="showDetails('stu3')">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm cursor-pointer" onclick="showDetails('stu4')">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm cursor-pointer" onclick="showDetails('stu5')">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm cursor-pointer" onclick="showDetails('stu6')">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm cursor-pointer" onclick="showDetails('stu7')">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm cursor-pointer" onclick="showDetails('stu8')">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm cursor-pointer" onclick="showDetails('stu9')">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm cursor-pointer" onclick="showDetails('stu10')">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm cursor-pointer" onclick="showDetails('stu11')">
