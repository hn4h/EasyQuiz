...
<head>
    ...
    <title>Name of user | EasyQuiz</title>
        ...
        <div class="body-container">
            ...
            <div class="flashcard-folder">
                <div class="flashcard-folder-header">
                    <a href="#" class="flashcard-folder-item-actived">Flashcard sets</a>
                    <a href="#" class="flashcard-folder-item">Folders</a>
                </div>
                <div class="search-user">
                    <input type="text" placeholder="Search flashcards" name="">
                    <i class="fa-solid fa-magnifying-glass"></i>
                </div>
